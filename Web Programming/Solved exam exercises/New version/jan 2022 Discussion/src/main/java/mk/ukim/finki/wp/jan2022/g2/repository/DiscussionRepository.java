...
public interface DiscussionRepository extends JpaRepository<Discussion, Long> {
    List<Discussion> findDiscussionsByParticipantsContaining(User user);
    List<Discussion> findDiscussionsByDueDateBefore(LocalDate date);
    List<Discussion> findDiscussionsByParticipantsContainingAndDueDateBefore(User user, LocalDate date);
